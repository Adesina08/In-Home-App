...
const INDEXES = {
  ...
  respondents: [{ study_id: 1 }, { unique_token: 1 }, { contact: 1 }, { account_id: 1 }, { interviewer_id: 1 }],
  diary_records: [{ study_id: 1 }, { respondent_id: 1 }, { status: 1 }],
  responses: [{ record_id: 1 }, { question_id: 1 }],
  media: [{ record_id: 1 }],
  question_imports: [{ study_id: 1 }],
  qc_flags: [{ record_id: 1 }, { respondent_id: 1 }, { status: 1 }],
  reminders: [{ respondent_id: 1 }, { status: 1 }],
  whatsapp_outbox: [{ respondent_id: 1 }],
  audit_log: [{ entity: 1, entity_id: 1 }],
  respondent_credentials: [{ respondent_id: 1 }],
  push_subscriptions: [{ respondent_id: 1 }],
  ai_summaries: [{ study_id: 1 }],
