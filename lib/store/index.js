...
const INDEXES = {
  diary_submissions:[{respondent_id:1},{state:1,lease_until:1}],
  interviewer_assignments:[{user_id:1,enabled:1},{study_id:1}],
  fieldwork_visits:[{user_id:1,visit_date:1},{study_id:1}],
  incentive_rules:[{study_id:1,enabled:1}],
  incentive_ledger:[{study_id:1,status:1},{respondent_id:1}],
  client_grants:[{user_id:1,study_id:1}],
  report_schedules:[{enabled:1,next_run:1}],
  report_snapshots:[{study_id:1,status:1},{created_at:-1}],
  research_alerts:[{study_id:1,status:1}],
  research_audit:[{study_id:1,created_at:-1}],
  backchecks:[{study_id:1,respondent_id:1}],
  privacy_requests:[{study_id:1,status:1}],
  theme_codes:[{study_id:1}],coded_verbatims:[{study_id:1,review_status:1}],
  studies: [{ status: 1 }],
  users: [{ email: 1 }, { role: 1 }],
  brands: [{ study_id: 1 }],
  consent_versions: [{ study_id: 1, version: -1 }],
  questions: [{ study_id: 1, order_index: 1 }],
  questionnaire_versions: [{ study_id: 1, version: -1 }],
  ...
  whatsapp_inbound_messages: [{ message_sid: 1 }, { respondent_id: 1 }, { created_at: -1 }],
  diary_records: [
    { study_id: 1 },
    { respondent_id: 1 },
    { status: 1 },
  ...
  mobile_sessions: [{ token_hash: 1 }, { expires_at: 1 }, { account_id: 1 }, { respondent_id: 1 }, { user_id: 1 }],
};
