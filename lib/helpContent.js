...
const admin = {
  ...
  sections: [
    ...
    {
      heading: "Setting a study up, step by step",
      path: "Studies → (pick a study)",
      body: [
        "A study's configuration is six screens, and they're in the order you'd naturally fill them in: Settings & Thresholds, then Questionnaire, Consent Wording, Client KPIs, Respondents and Media Review. Each one says which step it is and what comes next, with Back and Next buttons at the bottom.",
        "The order isn't arbitrary. Settings comes first because how often people log and how they're recruited changes what the later screens offer. The questionnaire comes before consent because the wording you approve should cover the questions you're actually asking.",
        "Moving to the next screen does not save the one you're on — each screen has its own Save button and that stays the only thing that writes. Save first, then move on.",
        "The tabs across the top do the same thing without the sequence, for when you know the app and just want one particular screen.",
      ],
      tips: ["You can leave and come back at any point; a study stays in draft until you set it live on the first screen."],
    },
    {
      heading: "Study Config → Settings & Thresholds",
      path: "Studies → (pick a study) → Settings & Thresholds tab · Step 1 of 6",
      body: [
    ...
    {
      heading: "Inviting a group of people at once",
      path: "Studies → (pick a study) → Respondents tab → \"Inviting a whole list? Upload it instead\"",
      body: [
        "For recruiting from a list rather than one person at a time. Three steps: download the template, fill it in, upload it — and then check what the app made of it before anything is sent.",
        "The template has two columns, name and phone. Anything else in your file is ignored, and the column headings are matched loosely, so a list exported from somewhere else usually works as it is.",
        "Numbers have to reach the phone network in international form (+234801…), but almost nobody writes them that way. Set the country code to assume on the upload screen and a list written the normal way — 08012345678 — is converted for you. Every number the app rewrote is shown with its original underneath, so you can spot a bad assumption before it costs you a message.",
        "The check screen sorts every row into: will invite, already on this study, duplicated inside your file, and needs fixing. Only the first group is sent anything. Rows that need fixing are skipped rather than guessed at — correct them in your file and upload it again.",
        "Nothing is written to the study and nothing is sent until you click the send button on that screen. When it does run, each person is created as \"invited\" with consent pending, exactly as a single invite would, and is texted a link to the invitation page — not straight into the diary.",
        "The last screen says plainly how many were invited, how many weren't, and why. If text messaging isn't connected on your deployment, it says so instead of reporting a send that never happened — the respondents still exist, and you can reach them another way.",
      ],
      tips: [
        "Numbers are matched against everyone already on the study, so re-uploading a list you have already used doesn't invite anyone twice.",
        "Write the study brief on Settings & Thresholds first. It's what the people you invite will read.",
      ],
    },
    {
      heading: "Study Config → Client KPIs",
      path: "Studies → (pick a study) → Client KPIs tab · Step 4 of 6",
      body: [
        "The handful of headline numbers the client sees at the top of their dashboard. Build each one from this study's own questions, so a KPI means something specific rather than being a generic count.",
        "Five things a KPI can measure: the percentage choosing a particular answer; the average of a numeric answer; the percentage of entries matching a condition; a straight count of entries; and the percentage of people with at least one matching entry — that last one is penetration, which answers \"how many of our sample ever did this\" rather than \"what share of occasions\".",
        "\"Only count entries where…\" narrows a KPI to a subset, and this is where cross-tabs come from. Set the measure to % choosing Brand A and add a condition that location is Home, and you get Brand A's share of at-home occasions. Add more than one condition and all of them must be true.",
        "Every KPI shows its live value on this screen as you build, plus what it was computed over — \"3 of 12 who answered\". Check that before handing the dashboard to a client: a KPI reading a dash here will read a dash for them too, and a percentage over a handful of entries is a very different number from the same percentage over hundreds.",
        "Percentages of a question divide by the people who ANSWERED that question, not by everyone. A question only some respondents were shown, because of skip logic, would otherwise look artificially low.",
        "Only submitted entries count. Drafts are half-finished, practice entries are training, and screened-out entries ended early before most questions were reached — including any of them would quietly understate every number.",
      ],
      tips: [
        "Toggle a KPI Off to hide it from the client without deleting the definition.",
        "Aim for five to ten. A dashboard with thirty tiles communicates less than one with six.",
      ],
    },
    {
...
const interviewer = {
  ...
  sections: [
    ...
    {
      heading: "Inviting a group of people",
      path: "My Respondents → Invite a group of people → (pick the study)",
      body: [
        "When you have a list of names and numbers rather than someone in front of you. Download the two-column template, fill it in, upload it, and check the result before anything is sent.",
        "Numbers written the normal way — 08012345678 — are converted into the international form the network needs. The check screen shows every number the app rewrote next to what you typed, so you can spot a mistake before it costs you a message.",
        "That screen also tells you which rows won't be sent: someone already on the study, the same number twice in your file, or a number that can't be dialled. Only the good rows are invited.",
        "Each person is texted a link to an invitation page — what the study is, how often they'd log, and a choice of how to take part. They aren't dropped straight into a consent form, which is what makes an unexpected text look like a scam.",
        "Nobody invited this way is registered or consented yet. They stay as \"invited\" until they open the link and agree for themselves.",
      ],
      tips: ["If texting isn't connected on your deployment, the last screen says so plainly rather than reporting a send that never happened."],
    },
  ],
};
