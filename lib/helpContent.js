  ...
  sections: [
    {
      ...
      body: [
        ...
        "The four cards at the top show Respondents, Diary Records, Completed entries, and Draft/Incomplete entries.",
    ...
    },
    {
      ...
      body: [
        ...
        "Skip Logic: rules that show or hide a later question (or a whole section) depending on how an earlier question was answered — e.g. only ask a follow-up if someone answered \"Yes\" to a previous question.",
...
const respondent = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: ["Your home screen lists every entry you've submitted, its status, and which of the three ways you used to log it."],
      tips: [],
    },
    {
      heading: "Reminders",
