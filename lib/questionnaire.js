...
async function loadQuestionnaire(studyId,context={}) {
  ...
  return { questions: require("./advancedQuestionnaire").contextualize(scoped,context), rules, allQuestions: questions, cadence };
}
