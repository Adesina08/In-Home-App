...
const email = require("./staffEmail");
      ...
      if (hoursSinceLast >= dueThreshold) {
        ...
        for (const channel of configuredChannels) {
          ...
          if (channel === "whatsapp" || channel === "sms") {
            ...
            try { result = await email.sendReminder({ name: r.name, email: r.contact, study: study.name, link: respondentDiaryUrlFromConfig(r.unique_token), missed: requirement === "missed" }); }
