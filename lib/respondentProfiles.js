...
function validate(values = {}) {
  ...
  if (!Number.isInteger(v.age) || v.age < 18 || v.age > 70) errors.age = "Enter an age between 18 and 70.";
  ...
  // Occupation and religion are dropdowns on the onboarding form, so the error
  // wording asks the respondent to choose rather than to type.
  if (!v.occupation) errors.occupation = "Choose your occupation. Pick 'Not currently working' or 'Other' where nothing fits.";
  if (!v.religion) errors.religion = "Choose your religion, or pick 'Prefer not to say'.";
