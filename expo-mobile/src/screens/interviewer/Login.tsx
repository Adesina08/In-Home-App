    ...
    >
      <View className="flex-1 justify-center gap-5 px-6">
        <View className="items-center gap-3">
          <View className="h-14 w-14 items-center justify-center rounded-2xl bg-[#EEF2FA] dark:bg-[rgba(29,78,216,0.18)]">
            <Icon name="users" size={26} color="#254680" strokeWidth={1.75} />
          </View>
        ...
        <View className="gap-3">
          <View>
            ...
            <TextInput
              ...
              className="h-11 rounded-xl border border-[#CBD5E1] bg-white px-3 text-[13px] text-[#0F172A] dark:border-[#1B3556] dark:bg-[#0F2038] dark:text-[#F8FAFC]"
            />
          </View>
          <View>
