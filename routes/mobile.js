...
// respondent can reach their diary -- without this mount every mobile login
// 404s at that step.
router.use("/api/profile", require("./mobileProfileApi"));
// Field interviewer persona in the Expo app: a separate bearer-token surface
// (staff `users`, not respondent accounts) mirroring routes/interviewer.js.
router.use("/api/interviewer", require("./mobileInterviewerApi"));
